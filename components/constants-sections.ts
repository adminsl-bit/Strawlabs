export const SECTIONS = [
    ...
    },
    {
        ...
        title: "Cohort 1.0 is closed. We’re entering build mode.",
        subtitle: "Applications are now closed for this cohort cycle. The selected student builders are moving into onboarding, execution, and hands-on project work across the Straw Labs ecosystem.",
        content: "",
        showButton: true,
        buttonText: "View Cohort Status",
        label: "Cohort",
    },
    {
        id: "contact",
