...
const simulationMaterial = new THREE.ShaderMaterial({
  ...
  `,
  uniforms: {
    uCurrentPosition: { value: new THREE.Texture() },
    uOriginalPosition: { value: new THREE.Texture() },
    uTime: { value: 0 },
    uCurl: { value: 1.5 },
    uSpeed: { value: 0.01 },
  },
...
const renderMaterial = new THREE.ShaderMaterial({
  ...
  `,
  uniforms: {
    uPosition: { value: new THREE.Texture() },
    uTime: { value: 0 },
  },
})
...
export function Scene() {
  ...
  useFrame((state) => {
    ...
    if (fbo1.texture && originalPositionTexture) {
      // Update simulation
  ...
  return (
    <>
      <points ref={pointsRef}>
        <bufferGeometry>
          <bufferAttribute attach="attributes-position" count={size * size} array={particlePositions} itemSize={3} args={[particlePositions, 3]} />
        </bufferGeometry>
