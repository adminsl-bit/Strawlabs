            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                    ...
                    <div className="relative h-80 w-full">
                        <AnimatePresence>
                            {testimonials.map((testimonial, index) => (
                                ...
                                >
                                    <div className="h-full w-full rounded-3xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center">
                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="h-7 w-7 rounded-full bg-white/10 flex items-center justify-center group/button hover:bg-white/20 transition-colors"
                        >
